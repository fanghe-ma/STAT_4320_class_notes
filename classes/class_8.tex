...
\begin{framed}
    \textbf{Definition} (Maximum Likelihood Estimation): Let $X_1, \hdots X_n$ iid from $F$ with \textit{pdf} or \textit{pmf} $ f_{ \theta}$. Consider the joint \textit{pdf} or \textit{pmf} 
    \[
...
\textbf{Ex} (Normal): $X_1, \hdots X_n$ iid $N(\mu, \sigma^2)$ 
